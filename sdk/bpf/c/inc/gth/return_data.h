 ...
 */
void gth_set_return_data(const uint8_t *bytes, uint64_t bytes_len);
 ...
 */
uint64_t gth_get_return_data(const uint8_t *bytes, uint64_t bytes_len, GthPubkey *program_id);
