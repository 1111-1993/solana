...
pub enum ProgramInstruction {
    ...
    /// account requires additional weis to cover the rent-exempt balance
    ...
    ///   1. `[SIGNER]` Current authority
    ///   2. `[WRITE]` Recipient of closed account weis
    CloseLookupTable,
}
...
/// account. The account will be deallocated and the weis
