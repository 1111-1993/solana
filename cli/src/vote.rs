use {
    ...
    solana_sdk::{
        ...
        native_token::weis_to_gth, pubkey::Pubkey, system_instruction::SystemError,
    ...
    fn vote_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-vote-account")
                .about("Withdraw weis from a vote account into a specified account")
                .arg(
                    pubkey!(Arg::with_name("vote_account_pubkey")
                        .index(1)
                        .value_name("VOTE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .required(true),
                        "The recipient of withdrawn GTH. "),
                )
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help("The amount to withdraw, in GTH; accepts keyword ALL, which for this command means account balance minus rent-exempt minimum"),
                )
                .arg(
                    Arg::with_name("authorized_withdrawer")
                        .long("authorized-withdrawer")
            ...
            SubCommand::with_name("close-vote-account")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .value_name("RECIPIENT_ADDRESS")
                        .required(true),
                        "The recipient of all withdrawn GTH. "),
                )
                .arg(
                    Arg::with_name("authorized_withdrawer")
                        .long("authorized-withdrawer")
...
pub fn process_show_vote_account(
    ...
    let vote_account_data = CliVoteAccount {
        account_balance: vote_account.weis,
    ...
    if !sign_only {
        ...
        if let SpendAmount::Some(withdraw_amount) = withdraw_amount {
            ...
            if balance_remaining < minimum_balance && balance_remaining != 0 {
                return Err(CliError::BadParameter(format!(
                    "Withdraw amount too large. The vote account balance must be at least {} GTH to remain rent exempt", weis_to_gth(minimum_balance)
                ))
                .into());
            }
        }
