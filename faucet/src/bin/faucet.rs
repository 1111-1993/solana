use {
    ...
    log::*,
    solana_clap_utils::input_parsers::{lamports_of_gth, value_of},
    solana_faucet::{
...
async fn main() {
    ...
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("per_time_cap")
                ...
                .value_name("NUM")
                .takes_value(true)
                .help("Request limit for time slice, in GTH"),
        )
        .arg(
            Arg::with_name("per_request_cap")
                ...
                .value_name("NUM")
                .takes_value(true)
                .help("Request limit for a single request, in GTH"),
        )
        .arg(
    ...
    let per_time_cap = lamports_of_gth(&matches, "per_time_cap");
    let per_request_cap = lamports_of_gth(&matches, "per_request_cap");
