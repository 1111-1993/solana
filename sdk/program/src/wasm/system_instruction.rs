...
impl SystemInstruction {
    pub fn createAccount(
        ...
        create_account(from_pubkey, to_pubkey, weis, space, owner)
    }
    ...
    pub fn createAccountWithSeed(
        ...
        create_account_with_seed(from_pubkey, to_pubkey, base, seed, weis, space, owner)
    }
    ...
    pub fn transfer(from_pubkey: &Pubkey, to_pubkey: &Pubkey, weis: u64) -> Instruction {
        transfer(from_pubkey, to_pubkey, weis)
    }
    ...
    pub fn createNonceAccount(
        ...
        let instructions = create_nonce_account(from_pubkey, nonce_pubkey, authority, weis);
    ...
    pub fn withdrawNonceAccount(
        ...
        withdraw_nonce_account(nonce_pubkey, authorized_pubkey, to_pubkey, weis)
    }
