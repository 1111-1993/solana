  ...
  return (
    <div className="card">
      ...
      <TableCardBody>
        ...
        <tr>
          <td>Weis Per Signature</td>
          <td className="text-lg-end">
            {sysvarAccount.info.feeCalculator.weisPerSignature}
          </td>
        </tr>
      </TableCardBody>
    </div>
  ...
  return (
    <div className="card">
      ...
      <TableCardBody>
        ...
        <tr>
          <td>Weis Per Byte Year</td>
          <td className="text-lg-end">
            {sysvarAccount.info.weisPerByteYear}
          </td>
        </tr>
      </TableCardBody>
    </div>
    ...
    <div className="card">
      ...
      <TableCardBody>
        ...
        <tr>
          ...
          <td className="text-lg-end font-monospace">
            {validatorPointValueFormatted} weis
          </td>
        </tr>
      </TableCardBody>
    </div>
