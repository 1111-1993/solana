...
extern crate alloc;
use {
    solana_program::{custom_panic_default, entrypoint::SUCCESS, log::gth_log_64, msg},
...
pub extern "C" fn entrypoint(_input: *mut u8) -> u64 {
    ...
    unsafe {
        ...
        gth_log_64(0x3, 0, 0, 0, u64::from(*ptr.add(42)));
...

    {
        ...
        gth_log_64(0x0, 0, 0, 0, sum as u64);
        assert_eq!(sum, ITERS);
    }

    {
        ...
        gth_log_64(0x4, 0, 0, 0, v.len() as u64);
