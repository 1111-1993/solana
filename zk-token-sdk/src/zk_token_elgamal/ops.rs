...
mod target_arch {
    ...
    fn op_with_lo_hi(
        ...
        let mut ct_result = pod::ElGamalCiphertext::zeroed();
        let result = unsafe {
            gth_zk_token_elgamal_op_with_lo_hi(
                op,
                &ct_0.0 as *const u8,
    ...
    fn op_with_scalar(
        ...
        let mut ct_result = pod::ElGamalCiphertext::zeroed();
        let result = unsafe {
            gth_zk_token_elgamal_op_with_scalar(
                op,
                &ct.0 as *const u8,
                scalar,
                &mut ct_result.0 as *mut u8,
...
extern "C" {
    pub fn gth_zk_token_elgamal_op(
        op: u64,
        ct_0: *const u8,
        ct_1: *const u8,
        ct_result: *mut u8,
    ) -> u64;
    pub fn gth_zk_token_elgamal_op_with_lo_hi(
        op: u64,
        ct_0: *const u8,
        ct_1_lo: *const u8,
        ct_1_hi: *const u8,
    ...
    pub fn gth_zk_token_elgamal_op_with_scalar(
        op: u64,
        ct: *const u8,
        scalar: u64,
        ct_result: *mut u8,
