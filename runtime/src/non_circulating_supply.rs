...
pub fn calculate_non_circulating_supply(bank: &Arc<Bank>) -> ScanResult<NonCirculatingSupply> {
        ...
        .contains(&AccountIndex::ProgramId)
    {
        bank.get_filtered_indexed_accounts(
            ...
            // zero-wei Account::Default() after being wiped and reinitialized in later
    ...
    let weis = non_circulating_accounts_set
        .iter()
...
mod tests {
    use {
        super::*,
        crate::genesis_utils::genesis_sysvar_and_builtin_program_weis,
        solana_sdk::{
