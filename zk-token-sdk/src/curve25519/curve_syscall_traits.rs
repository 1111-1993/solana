...
// `GroupOperations`.
extern "C" {
    pub fn gth_curve_validate_point(curve_id: u64, point: *const u8, result: *mut u8) -> u64;
    ...
    pub fn gth_curve_multiscalar_mul(
        curve_id: u64,
        scalars: *const u8,
        points: *const u8,
        result: *mut u8,
    ...
    pub fn gth_curve_pairing_map(curve_id: u64, point: *const u8, result: *mut u8) -> u64;
}
