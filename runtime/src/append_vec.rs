...
impl<'a> StoredAccountMeta<'a> {
    ...
    fn sanitize(&self) -> bool {
        self.sanitize_executable() && self.sanitize_weis()
    }
    ...
    fn sanitize_weis(&self) -> bool {
        // Sanitize 0 weis to ensure to be same as AccountSharedData::default()
        self.account_meta.weis != 0 || self.clone_account() == AccountSharedData::default()
    }
...
pub mod tests {
    ...
    #[test]
    fn test_new_from_file_crafted_zero_wei_account() {
