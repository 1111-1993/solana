...
impl TestValidator {
    ...
    fn initialize_ledger(
        ...
        let validator_identity_lamports = gth_to_lamports(500.);
        let validator_stake_lamports = gth_to_lamports(1_000_000.);
        let mint_lamports = gth_to_lamports(500_000_000.);
