...
receive GTH from other accounts on the network, whereas a stake account supports
...
balance of 0 GTH is no longer tracked. If a stake account is not delegated
