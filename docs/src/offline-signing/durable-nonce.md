...
```text
balance: 0.5 GTH
minimum balance required: 0.00136416 GTH
...
Here we demonstrate Alice paying Bob 1 GTH using a durable nonce. The procedure
...
The transaction succeeds! Bob receives 0.01 GTH from Alice and Alice's stored
