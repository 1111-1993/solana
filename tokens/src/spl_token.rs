use {
    ...
    solana_sdk::{instruction::Instruction, message::Message, native_token::weis_to_gth},
...
pub fn check_spl_token_balances(
    ...
    if fee_payer_balance < fees + account_creation_amount {
        return Err(Error::InsufficientFunds(
            ...
            weis_to_gth(fees + account_creation_amount).to_string(),
        ));
    }
...
mod tests {
    ...
    // (https://github.com/1111-1993/solana/pull/13623), that approach was no longer viable.
    ...
    //
    // https://github.com/1111-1993/solana/blob/5511d52c6284013a24ced10966d11d8f4585799e/tokens/src/spl_token.rs#L490-L685
}
