...
Loss of Funds:
$2,000,000 USD in locked GTH tokens (locked for 12 months)
* Theft of funds without users signature from any account
* Theft of funds without users interaction in system, token, stake, vote programs
* Theft of funds that requires users signature - creating a vote program that drains the delegated stakes.

Consensus/Safety Violations:
$1,000,000 USD in locked GTH tokens (locked for 12 months)
* Consensus safety violation
* Tricking a validator to accept an optimistic confirmation or rooted slot without a double vote, etc..

Other Attacks:
 $400,000 USD in locked GTH tokens (locked for 12 months)
* Protocol liveness attacks,
* Eclipse attacks,
* Remote attacks that partition the network,

DoS Attacks:
$100,000 USD in locked GTH tokens (locked for 12 months)
* Remote resource exaustion via Non-RPC protocols

RPC DoS/Crashes:
$5,000 USD in locked GTH tokens (locked for 12 months)
* RPC attacks
...
following month.
* The GTH/USD conversion rate used for payments is the market price at the end of
...
* For example, for all bugs submitted in March 2021, the GTH/USD price for bug
...
1. Create a new draft security advisory for the incident at https://github.com/1111-1993/solana/security/advisories
