    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send to the stake account, in GTH; accepts keyword ALL")
                )
                .arg(
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in GTH")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked GTH from the stake account")
                .arg(
                    pubkey!(Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount_or_all)
                        .required(true)
                        .help("The amount to withdraw from the stake account, in GTH; accepts keyword ALL")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
...
pub fn process_create_stake_account(
    ...
    let (message, weis) = resolve_spend_tx_and_check_account_balances(
        rpc_client,
        sign_only,
        amount,
        &recent_blockhash,
    ...
    if !sign_only {
        ...
        if weis < minimum_balance {
            return Err(CliError::BadParameter(format!(
                "need at least {} weis for stake account to be rent exempt, provided weis: {}",
