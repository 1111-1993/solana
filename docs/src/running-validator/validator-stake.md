...
Now delegate 1 GTH to your validator by first creating your stake account:
...
> Don’t delegate your remaining GTH, as your validator will use those tokens to vote.
...
The rewards weis earned are split between your stake account and the vote
...
These vote transactions are paid for by weis from a validator's identity
account.
...
cli's `withdraw-stake` command to recover the previously staked weis.
