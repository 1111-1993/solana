...
This guide describes how to add Solana's native token GTH to your cryptocurrency
exchange.
...
here](https://github.com/1111-1993/solana/blob/583cec922b6107e0f85c7e14cb5e642bc7dfb340/core/src/ledger_cleanup_service.rs#L15-L26).
...
[`solana-watchtower`](https://github.com/1111-1993/solana/blob/master/watchtower/README.md),
...
some GTH, they exist. To set up a deposit account for your exchange, simply
...
[rent](developing/programming-model/accounts.md#rent) in GTH. In order to find
...
greater security. If so, you will need to move GTH to hot accounts using our
[offline methods](../offline-signing.md).

## Listening for Deposits

When a user wants to deposit GTH into your exchange, instruct them to send a
...
[Rust SDK](https://github.com/1111-1993/solana) or
[Javascript SDK](https://github.com/1111-1993/solana-web3.js).
...
To accommodate a user's request to withdraw GTH, you must generate a Solana
...
The [Solana Javascript SDK](https://github.com/1111-1993/solana-web3.js)
...
Every deposit and withdrawal of GTH must be greater or equal to the minimum
rent-exempt balance for the account at the wallet address (a basic GTH account
holding no data), currently: 0.000890880 GTH
...
The SPL Token workflow is similar to that of native GTH tokens, but there are a
...
recommended that the addresses for these accounts be derived from GTH deposit
wallets using the
...
The withdrawal address a user provides must be the that of their GTH wallet.
...
account data. If the address has no GTH balance, user confirmation should be
...
[TransferChecked](https://github.com/1111-1993/solana-program-library/blob/fc0d6a2db79bd6499f04b9be7ead0c400283845e/token/program/src/instruction.rs#L268)
...
run `solana airdrop 1` to obtain some devnet or testnet GTH for development and testing.
