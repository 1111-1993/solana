...
function display_results_summary {
  ...
  stake_account_balance_total_gth="$(bc <<< "scale=3; $stake_account_balance_total/$LAMPORTS_PER_GTH")"
  system_account_balance_gth="$(bc <<< "scale=3; $system_account_balance/$LAMPORTS_PER_GTH")"

  all_account_total_balance="$(bc <<< "scale=3; $system_account_balance+$stake_account_balance_total")"
  all_account_total_balance_gth="$(bc <<< "scale=3; ($system_account_balance+$stake_account_balance_total)/$LAMPORTS_PER_GTH")"
