...
mod tests {
    use {
        ...
        solana_runtime::genesis_utils::{
            bootstrap_validator_stake_weis, create_genesis_config_with_leader,
        },
    };
    ...
    fn test_leader_schedule_via_bank() {
        ...
        let genesis_config =
            create_genesis_config_with_leader(0, &pubkey, bootstrap_validator_stake_weis())
                .genesis_config;
    ...
    fn test_leader_scheduler1_basic() {
        let pubkey = solana_sdk::pubkey::new_rand();
        let genesis_config =
            create_genesis_config_with_leader(42, &pubkey, bootstrap_validator_stake_weis())
                .genesis_config;
        let bank = Bank::new_for_tests(&genesis_config);
