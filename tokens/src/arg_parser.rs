use {
    ...
    solana_sdk::native_token::gth_to_lamports,
    ...
    App::new(crate_name!())
            ...
            SubCommand::with_name("distribute-tokens")
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in GTH"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_gth")
                        .default_value("1.0")
                        .long("unlocked-gth")
                        .takes_value(true)
                        .value_name("GTH_AMOUNT")
                        .help("Amount of GTH to put in system account to pay for fees"),
                )
                .arg(
...
fn parse_distribute_tokens_args(
    ...
    Ok(DistributeTokensArgs {
        ...
        stake_args: None,
        spl_token_args: None,
        transfer_amount: value_of(matches, "transfer_amount").map(gth_to_lamports),
    })
}
...
fn parse_create_stake_args(
    ...
    let stake_args = StakeArgs {
        unlocked_gth: gth_to_lamports(value_t_or_exit!(matches, "unlocked_gth", f64)),
        lockup_authority,
