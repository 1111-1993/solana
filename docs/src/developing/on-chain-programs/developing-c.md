...
Loader](https://github.com/1111-1993/solana/blob/7ddf10e602d2ed87a9e3737aa8c32f1db9f909d8/sdk/program/src/bpf_loader.rs#L17)
and [BPF loader
deprecated](https://github.com/1111-1993/solana/blob/7ddf10e602d2ed87a9e3737aa8c32f1db9f909d8/sdk/program/src/bpf_loader_deprecated.rs#L14).
...
- [BPF Loader
  deserialization](https://github.com/1111-1993/solana/blob/d2ee9db2143859fa5dc26b15ee6da9c25cc0429c/sdk/bpf/c/inc/solana_sdk.h#L304)
- [BPF Loader deprecated
  deserialization](https://github.com/1111-1993/solana/blob/8415c22b593f164020adc7afe782e8041d756ddf/sdk/bpf/c/inc/deserialize_deprecated.h#L25)
...
[GthParameters](https://github.com/1111-1993/solana/blob/8415c22b593f164020adc7afe782e8041d756ddf/sdk/bpf/c/inc/solana_sdk.h#L276)
structure:
...
represented as a
[GthAccountInfo](https://github.com/1111-1993/solana/blob/8415c22b593f164020adc7afe782e8041d756ddf/sdk/bpf/c/inc/solana_sdk.h#L173)
structures. An account's place in the array signifies its meaning, for example,
when transferring weis an instruction may define the first account as the
source and the second as the destination.

The members of the `GthAccountInfo` structure are read-only except for
`weis` and `data`. Both may be modified by the program in accordance with
...
`GthAccountInfo` entries in the array but they both point back to the original
...
[`calloc`](https://github.com/1111-1993/solana/blob/c3d2d2134c93001566e1e56f691582f379b5ae55/sdk/bpf/c/inc/solana_sdk.h#L245)
...
- [`gth_log(const char*)`](https://github.com/1111-1993/solana/blob/d2ee9db2143859fa5dc26b15ee6da9c25cc0429c/sdk/bpf/c/inc/solana_sdk.h#L128)
- [`gth_log_64(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t)`](https://github.com/1111-1993/solana/blob/d2ee9db2143859fa5dc26b15ee6da9c25cc0429c/sdk/bpf/c/inc/solana_sdk.h#L134)
...
Use the system call
[`gth_log_compute_units()`](https://github.com/1111-1993/solana/blob/d3a3a7548c857f26ec2cb10e270da72d373020ec/sdk/bpf/c/inc/solana_sdk.h#L140)
...
The [Solana Program Library github](https://github.com/1111-1993/solana-program-library/tree/master/examples/c) repo contains a collection of C examples
