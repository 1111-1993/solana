...
pub enum CliError {
    ...
    #[error("Account {1} has insufficient funds for fee ({0} GTH)")]
    InsufficientFundsForFee(f64, Pubkey),
    #[error("Account {1} has insufficient funds for spend ({0} GTH)")]
    InsufficientFundsForSpend(f64, Pubkey),
    #[error("Account {2} has insufficient funds for spend ({0} GTH) + fee ({1} GTH)")]
