...
## Minimum GTH requirements

There is no strict minimum amount of GTH required to run a validator on Solana.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 GTH. Voting also requires sending a vote
