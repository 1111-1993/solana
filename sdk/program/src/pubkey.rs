...
impl Pubkey {
    ...
    pub fn try_find_program_address(seeds: &[&[u8]], program_id: &Pubkey) -> Option<(Pubkey, u8)> {
        ...
        {
            extern "C" {
                fn gth_try_find_program_address(
                    seeds_addr: *const u8,
                    seeds_len: u64,
    ...
    pub fn log(&self) {
        ...
        {
            extern "C" {
                fn gth_log_pubkey(pubkey_addr: *const u8);
            }
            unsafe { gth_log_pubkey(self.as_ref() as *const _ as *const u8) };
        }

        #[cfg(not(target_arch = "bpf"))]
        crate::program_stubs::gth_log(&self.to_string());
    }
}
