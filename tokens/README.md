...
Currently, this will subtract 1 GTH from each allocation and store it the
recipient address. That GTH can be used to pay transaction fees on staking
...
Distributing SPL Tokens works very similarly to distributing GTH, but requires
...
As with GTH, you can List the differences between a list of expected
