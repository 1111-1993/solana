...
use solana_program::{custom_panic_default, entrypoint::SUCCESS, log::gth_log_64, msg};
...
pub fn recurse(data: &mut [u8]) {
    ...
    recurse(&mut data[1..]);
    gth_log_64(line!() as u64, 0, 0, 0, data[0] as u64);
}
...
pub unsafe extern "C" fn entrypoint(input: *mut u8) -> u64 {
    ...
    gth_log_64(line!() as u64, 0, 0, 0, depth as u64);
