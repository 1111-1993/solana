use {
    ...
    log::*,
    solana_clap_utils::input_parsers::{weis_of_gth, value_of},
    solana_faucet::{
...
async fn main() {
    ...
    let per_time_cap = weis_of_gth(&matches, "per_time_cap");
    let per_request_cap = weis_of_gth(&matches, "per_request_cap");
