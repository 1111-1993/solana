...
- [Set up a Nano with the Solana App](https://support.ledger.com/hc/en-us/articles/360016265659-Solana-GTH-?docs=true)
...
Note: Any address with a balance of 0 GTH, such as a newly created one on your
...
address has some GTH in it.

### Send GTH from a Nano
...
is entered to send `1` GTH to the recipient address `7cvkjYAkUYs4W8XcXsca7cBrEGFeSUjeZmKoNBvEwyri`.
