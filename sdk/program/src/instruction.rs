...
/// when calling the `gth_get_processed_sibling_instruction` syscall.
#[repr(C)]
...
pub fn get_processed_sibling_instruction(index: usize) -> Option<Instruction> {
    ...
    {
        extern "C" {
            fn gth_get_processed_sibling_instruction(
                index: u64,
        ...
        if 1 == unsafe {
            gth_get_processed_sibling_instruction(
                index as u64,
                &mut meta,
                &mut program_id,
                &mut u8::default(),
    ...
    crate::program_stubs::gth_get_processed_sibling_instruction(index)
}
...
pub fn get_stack_height() -> usize {
    ...
    {
        extern "C" {
            fn gth_get_stack_height() -> u64;
        }

        unsafe { gth_get_stack_height() as usize }
    }

    #[cfg(not(target_arch = "bpf"))]
    {
        crate::program_stubs::gth_get_stack_height() as usize
    }
}
