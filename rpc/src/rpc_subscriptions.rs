        ...
        let t_cleanup = Builder::new()
            ...
            .spawn(move || {
                let pool = rayon::ThreadPoolBuilder::new()
                    ...
                    .thread_name(|i| format!("gth-sub-notif-{}", i))
                    .build()
                    .unwrap();
                pool.install(|| {
...
pub(crate) mod tests {
    use {
        ...
        crate::{
            ...
            rpc_pubsub::RpcGthPubSubInternal,
            rpc_pubsub_service,
        },
        serial_test::serial,
    ...
    fn make_account_result(weis: u64, subscription: u64, data: &str) -> serde_json::Value {
        json!({
           "jsonrpc": "2.0",
    ...
    fn test_check_program_subscribe_for_missing_optimistically_confirmed_slot() {
        ...
        let build_expected_resp = |slot: Slot, weis: u64, pubkey: &str, subscription: i32| {
            json!({
               "jsonrpc": "2.0",
               "method": "programNotification",
               "params": {
