        ...
        self.last_voted_slot_hash()
            .map(|(last_voted_slot, last_voted_hash)| {
                ...
                let suspended_decision_due_to_major_unsynced_ledger = || {
                    ...
                    // at the banking stage: https://github.com/1111-1993/solana/issues/8232)
                    //
...
pub mod test {
    ...
    fn test_stake_is_updated_for_entire_branch() {
        ...
        Tower::update_ancestor_voted_stakes(&mut voted_stakes, 2, account.weis(), &ancestors);
