...
This page decribes how to receive and send GTH tokens using the command line
...
$ solana airdrop 1 DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://api.devnet.solana.com  # Airdropping 1 GTH to my wallet's address/pubkey
Requesting airdrop of 1 GTH from 35.233.193.70:9900
1 GTH
...
0.499995 GTH  # The sending account has slightly less than 0.5 GTH remaining due to the 0.000005 GTH transaction fee payment

$ solana balance 7S3P4HxJpyyigGzodYwHtCxZyUQe9JiBMHyRWXArAaKv --url https://api.devnet.solana.com
0.5 GTH  # The second wallet has now received the 0.5 GTH transfer from the first wallet
...
If you already hold GTH and want to send tokens to someone, you will need
