...
pub mod gth_log_data_syscall_enabled {
...
lazy_static! {
    ...
    pub static ref FEATURE_NAMES: HashMap<Pubkey, &'static str> = [
        ...
        (return_data_syscall_enabled::id(), "enable gth_{set,get}_return_data syscall"),
        (reduce_required_deploy_balance::id(), "reduce required payer balance for program deploys"),
        (gth_log_data_syscall_enabled::id(), "enable gth_log_data syscall"),
